...
public class ApproveDeleteRequest extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ApproveDeleteRequest
     */
    public ApproveDeleteRequest() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApproveDeleteRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApproveDeleteRequest().setVisible(true);
            }
        });
    }
